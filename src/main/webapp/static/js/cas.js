head.ready(document, function () {
    if (!window.jQuery) {
        head.load("https://cdnjs.cloudflare.com/ajax/libs/jquery/1.11.3/jquery.min.js", loadjQueryUI);
    } else {
...
function loadjQueryUI() {
    head.load("https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js", loadjQueryCookies);
}
